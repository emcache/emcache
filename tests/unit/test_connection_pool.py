...
class TestConnectionPool:
    ...
    async def test_close(self, mocker):
        ...
        connection_pool = ConnectionPool(MemcachedHostAddress("localhost", 11211), 1, 1, None, None, lambda _: _, False, False, None)
    ...
    async def test_initalizes_creating_min_connection(self, mocker, not_closed_connection, min_connections):
        ...
        connection_pool = ConnectionPool(
            MemcachedHostAddress("localhost", 11211), max_connections, min_connections, None, None, lambda _: _, False, False, None
        )
    ...
    async def test_create_connection_tries_again_if_error(self, event_loop, mocker, not_closed_connection, exc):
        ...
        connection_pool = ConnectionPool(MemcachedHostAddress("localhost", 11211), 1, 1, None, 1.0, lambda _: _, False, False, None)
        ...
        create_protocol.assert_has_calls(
            [
                call(MemcachedHostAddress("localhost", 11211), ssl=False, ssl_verify=False, ssl_extra_ca=None, timeout=1.0),
                call(MemcachedHostAddress("localhost", 11211), ssl=False, ssl_verify=False, ssl_extra_ca=None, timeout=1.0),
            ]
        )
    ...
    async def test_connection_context_one_create_connection(self, event_loop, mocker, not_closed_connection):
        ...
        connection_pool = ConnectionPool(MemcachedHostAddress("localhost", 11211), 3, 1, None, None, lambda _: _, False, False, None)
    ...
    async def test_connection_context_max_connections(self, event_loop, mocker, not_closed_connection):
        ...
        connection_pool = ConnectionPool(MemcachedHostAddress("localhost", 11211), 2, 1, None, None, lambda _: _, False, False, None)
    ...
    async def test_connection_context_create_connection_if_closed(self, event_loop, mocker, not_closed_connection):
        ...
        create_protocol.assert_has_calls(
            [
                call(MemcachedHostAddress("localhost", 11211), ssl=False, ssl_verify=False, ssl_extra_ca=None, timeout=None),
                call(MemcachedHostAddress("localhost", 11211), ssl=False, ssl_verify=False, ssl_extra_ca=None, timeout=None),
            ]
        )
        assert connection_pool.total_connections == 1
    ...
    async def test_purge_connections(self, event_loop, mocker):
        ...
        connection_pool = ConnectionPool(MemcachedHostAddress("localhost", 11211), 3, 1, 60, None, lambda _: _, False, False, None)
    ...
    async def test_purge_not_the_beyond_min_connections(self, event_loop, mocker, min_connections):
        ...
        max_connections = min_connections
        connection_pool = ConnectionPool(
            MemcachedHostAddress("localhost", 11211), max_connections, min_connections, 60, None, lambda _: _, False, False, None
        )
    ...
    async def test_create_and_update_connection_timestamp(self, event_loop, mocker, not_closed_connection):
        ...
        connection_pool = ConnectionPool(MemcachedHostAddress("localhost", 11211), 1, 1, 60, None, lambda _: _, False, False, None)
    ...
    async def test_unhealthy_healthy(self, event_loop, mocker, not_closed_connection):
        ...
        connection_pool = ConnectionPool(MemcachedHostAddress("localhost", 11211), 1, 1, None, 1.0, cb_mock, False, False, None)
